...
$EXPORTFILENAME = "VMHost_Compare_" + $VCSA + "_Ref_" + $REFVMHOST.Name + "_Compare_" +$CHKVMHOST.Name + "_" + $LOGDATE + ".csv"
...
$VIBDIFF = $CHKVIBS
ForEach($VIB in ($CHKVIBs.Name))
{
	If(($REFVIBs.Name) -eq $VIB)
	{
		$VIBDIFF = $VIBDIFF | Where{$_.Name -ne $VIB}
	}
}
Write-Host "List of Different VIBs includes:" -ForeGroundColor Green
$VIBDIFF | Sort Name | ft
...
$VIBDIFF | Sort Name | Export-CSV -PATH $EXPORTFILE -NoTypeInformation
