...
$EXPORTFILENAME = "VMHostAudit_" + $VCSA + "_"+ $VMHOST.Name + "_" + $LOGDATE + ".csv"
...
Write-Host "-----------------------------------------------------------------------------------------------------------------------"
Write-Host (Get-Date -format "MMM-dd-yyyy_HH-mm-ss")
Write-Host "Getting VIBs List"
#ESXCLI
$esxcli = Get-EsxCli -VMHost $VMHOST -V2
$VIBs = $esxcli.software.vib.get.Invoke()
...
$VIBs | Sort Name | Export-CSV -PATH $EXPORTFILE -NoTypeInformation
