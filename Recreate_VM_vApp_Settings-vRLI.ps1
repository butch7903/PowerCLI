<#
	...
	.SYNOPSIS
		This script will recreate the vApp Settings for vRLI.

	.DESCRIPTION
		Use this script to select a VM that had the vRLI vApp settings 
...
$PRODUCTTEMP = New-Object VMware.Vim.VAppProductSpec
$PRODUCTTEMP[0].Info = New-Object VMware.Vim.VAppProductInfo
$PRODUCTTEMP[0].Info.key = 1
$PRODUCTTEMP[0].Info.ClassId = "vami"
$PRODUCTTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
...
Write-Host "Setting vRLI Property Information"
$PROPERTYARRAY = @()

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 0
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
$PROPERTYTEMP[0].Info.Id = "preferipv6"
$PROPERTYTEMP[0].Info.Category = "Networking Properties"
$PROPERTYTEMP[0].Info.Label = "Prefer IPv6 addresses"
...
$PROPERTYTEMP[0].Info.Description = "Give preference to IPv6 addresses when both IPv4/IPv6 are available"
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 1
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
$PROPERTYTEMP[0].Info.Id = "domain"
$PROPERTYTEMP[0].Info.Category = "Networking Properties"
$PROPERTYTEMP[0].Info.Label = "DNS domain"
$PROPERTYTEMP[0].Info.Type = "string"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please Specify the vApp Domain. Example hamker.local"
$PROPERTYTEMP[0].Info.Description = "The domain name server domain for this VM. Note this option only works if DNS is specified above."
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 2
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
$PROPERTYTEMP[0].Info.Id = "hostname"
$PROPERTYTEMP[0].Info.Category = "Networking Properties"
$PROPERTYTEMP[0].Info.Label = "Hostname"
$PROPERTYTEMP[0].Info.Type = "string"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please provide the FQDN of this vApp. Example vrli01.hamker.local"
$PROPERTYTEMP[0].Info.Description = "The hostname or the fully qualified domain name for this VM. Leave blank if DHCP is desired."
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 3
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
...
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please provide the IP address of this vApp. Example 192.168.1.55"
...
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please provide the Network Gateway. Example 192.168.1.1"
...
$PROPERTYTEMP[0].Info.DefaultValue = "VMware_vCenter_Log_Insight"
...
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please Provide the Subnet Mas for the vApp. Example 255.255.255.0"
...
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 7
$PROPERTYTEMP[0].Info.ClassId = "vm"
$PROPERTYTEMP[0].Info.InstanceId = ""
$PROPERTYTEMP[0].Info.Id = "rootpw"
$PROPERTYTEMP[0].Info.Category = "Other Properties"
$PROPERTYTEMP[0].Info.Label = "Root Password"
$PROPERTYTEMP[0].Info.Type = "password"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = ""
$PROPERTYTEMP[0].Info.Description = "A root password can be set if desired and will override any already set password. If not, but guest customization is running, then it will be randomly generated. Otherwise the password will be blank, and will be required to change in the console before using SSH. For security reasons, it is recommended to use a password that is a minimum of eight characters and contains a minimum of one upper, one lower, one digit, and one special character."
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 8
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
$PROPERTYTEMP[0].Info.Id = "DNS"
$PROPERTYTEMP[0].Info.Category = "Networking Properties"
$PROPERTYTEMP[0].Info.Label = "DNS"
$PROPERTYTEMP[0].Info.Type = "string"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please provide the DNS IPs in comma seperated format. Example: 192.168.1.32,192.168.1.33"
$PROPERTYTEMP[0].Info.Description = "The domain name servers for this VM (comma separated). Leave blank if DHCP is desired. WARNING: Do not specify more than two DNS entries or no DNS entries will be configured!"
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 9
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = "VMware_vCenter_Log_Insight"
$PROPERTYTEMP[0].Info.Id = "searchpath"
$PROPERTYTEMP[0].Info.Category = "Networking Properties"
$PROPERTYTEMP[0].Info.Label = "DNS searchpath"
$PROPERTYTEMP[0].Info.Type = "string"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = Read-Host "Please provide the DNS Search path in comma seperated format. Example: hamker.local,hamker.com"
$PROPERTYTEMP[0].Info.Description = "The domain name server searchpath for this VM (comma or space separated). Note this option only works if DNS is specified above."
$PROPERTYARRAY += $PROPERTYTEMP

$PROPERTYTEMP = $null
$PROPERTYTEMP = New-Object VMware.Vim.VAppPropertySpec
$PROPERTYTEMP[0].Info = New-Object VMware.Vim.VAppPropertyInfo
$PROPERTYTEMP[0].Info.key = 10
$PROPERTYTEMP[0].Info.ClassId = "vami"
$PROPERTYTEMP[0].Info.InstanceId = ""
$PROPERTYTEMP[0].Info.Id = "sshkey"
$PROPERTYTEMP[0].Info.Category = "Other Properties"
$PROPERTYTEMP[0].Info.Label = "SSH Public Key"
$PROPERTYTEMP[0].Info.Type = "string"
$PROPERTYTEMP[0].Info.TypeReference = ""
$PROPERTYTEMP[0].Info.UserConfigurable = $True
$PROPERTYTEMP[0].Info.DefaultValue = ""
$PROPERTYTEMP[0].Info.Value = ""
$PROPERTYTEMP[0].Info.Description = "An SSH Public Key can be set if desired, disabling password authentication. If blank during initial deployment, SSH will be configured per the Root Password option above. Entering a new SSH Public Key will append to (not override) the already configured Public Key(s)."
$PROPERTYARRAY += $PROPERTYTEMP
